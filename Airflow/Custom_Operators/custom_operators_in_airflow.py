# Consolidate repeated code into custom Operator Plugins, can easily be reused going forward
## HasRowsOperator, a custom data quality check to ensure rows were inserted
## S3toRedshift, custom operator
...
dag = DAG(
    "lesson3.exercise1",
    # because start date in past, will backfill
    start_date=datetime.datetime(2018, 1, 1, 0, 0, 0, 0),
    end_date=datetime.datetime(2018, 12, 1, 0, 0, 0, 0),
    schedule_interval="@monthly",
    # So DAGs cannot run in parallel
    max_active_runs=1
)
